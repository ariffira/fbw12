...
let p2 = new Promise(function (resolve, reject) {
    resolve(products);
    reject('This product has a fix price');
});
function checkPrice(proName) {
    ...
    p2
        .then((products) => {
            for (let i in products) {
                if (products[i].product_name == proName) {
                    let priceP = eval(products[i].product_price);
                    ...
                    if (priceP >= 500) {
                       ...
                       <div class="container">
                        ${products[i].product_image}
                         <div class="card-body">
                          <h5 class="card-title" id="productId">${products[i].product_name} </h5>
                          <p class="card-text"><ul><li>id=${products[i].productId}</li><li>name=${products[i].product_name}</ li><li>price=<del>${products[i].product_price}€</del></li>
                        ...
                        ${products[i].product_image}
                         <div class="card-body">
                          <h5 class="card-title" id="productId">${products[i].product_name} </h5>
                          <p class="card-text"><ul><li>id=${products[i].productId}</li><li>name=${products[i].product_name}</ li><li>price=${products[i].product_price}€</li>
