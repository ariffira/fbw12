...
//     </tr>`;
// }
// // Add new user to the array using : push() method
// // let newObject = {
// //     id:3,
// //     name: {
// //         firstName: 'Sujatha',
...
// //     }
// // };
// // users.push(newObject);// new user will add here
// // console.table(users);
// // when user click to add
// let addUser = () => {
//     // get user data from html form
...
//         }
//     };
//     users.unshift(newUser); // new user will add here
//     console.table(users);
//     tabledata.innerHTML = ''; // make it empty
//     for (let i = 0; i < users.length; i++) {
//         tabledata.innerHTML +=
//             `<tr>
//             <td>${users[i].id}</td>
